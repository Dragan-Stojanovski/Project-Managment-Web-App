 ...
 */
const AutocompleteMovementTypeField = <
  TFieldValues extends FieldValues,
  TFieldName extends Path<TFieldValues>
>({
  // nullable,
...
const professionsData = [
    { value: '1', label: 'Movement 1', tooltip: 'First option' },
    { value: '2', label: 'Movement 2', tooltip: 'Second option' }
  ];
...
export default AutocompleteMovementTypeField;